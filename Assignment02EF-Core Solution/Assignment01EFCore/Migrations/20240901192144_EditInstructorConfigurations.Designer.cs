...
namespace Assignment01EFCore.Migrations
{
    ...
    [Migration("20240901192144_EditInstructorConfigurations")]
    partial class EditInstructorConfigurations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment01EFCore.Entities.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment01EFCore.Entities.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("Assignment01EFCore.Entities.Instructor", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("Assignment01EFCore.Entities.Student", b =>
                {
                    b.HasOne("Assignment01EFCore.Entities.Department", "Department")
                        .WithMany("Students")
                        .HasForeignKey("DeptId")
                        .OnDelete(DeleteBehavior.SetNull);
